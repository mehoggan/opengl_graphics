 ...
 *
 */
#ifndef INTERLEAVED_DATUM_9D_H_INCLUDED
#define INTERLEAVED_DATUM_9D_H_INCLUDED
...
namespace gl_wrapper
{
  ...
  public:
    ...
    /*! \brief determine type of the ninth interleaved type
     */
    typedef T9 internal_type9;
    ...
    /*! \brief ninth component in interleaved data
     */
    T9 _datum9;
    ...
    /*! \brief constructor
     */
    interleaved_datum_9d(const T1 &datum_1, const T2 &datum_2,
     ...
     */
    interleaved_datum_9d(const interleaved_datum_9d &rhs);

    /*! \brief assignment uses copy-swap idiom
     */
    interleaved_datum_9d &operator=(interleaved_datum_9d rhs);
  };
}

#include "interleaved_datum_9d.inl"
#endif
