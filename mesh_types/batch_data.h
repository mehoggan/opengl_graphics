...
#include <graphics/ref_count/shared_array/shared_array.h>
#include <graphics/mesh_types/batch_traits.h>
...
namespace gl_wrapper
{
  ...
  public:
    typedef T1 type1;
    typedef ref_count::shared_array<type1> collection1_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type1> collection1_type;
    typedef T2 type2;
    typedef ref_count::shared_array<type2> collection2_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type2> collection2_type;
    typedef T3 type3;
    typedef ref_count::shared_array<type3> collection3_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type3> collection3_type;
    typedef T4 type4;
    typedef ref_count::shared_array<type4> collection4_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type4> collection4_type;
    typedef T5 type5;
    typedef ref_count::shared_array<type5> collection5_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type5> collection5_type;
    typedef T6 type6;
    typedef ref_count::shared_array<type6> collection6_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type6> collection6_type;
    typedef T7 type7;
    typedef ref_count::shared_array<type7> collection7_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type7> collection7_type;
    typedef T8 type8;
    typedef ref_count::shared_array<type8> collection8_type;
...
namespace gl_wrapper
{
  ...
  public:
    ...
    typedef ref_count::shared_array<type8> collection8_type;
    typedef T9 type9;
    typedef ref_count::shared_array<type9> collection9_type;
