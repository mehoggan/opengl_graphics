 ...
 *
 */
#ifndef INTERLEAVED_DATUM_6D_H_INCLUDED
#define INTERLEAVED_DATUM_6D_H_INCLUDED
...
namespace opengl_graphics
{
  ...
  public:
     ...
     */
    interleaved_datum_6d();

    /*! \brief constructor
     */
    interleaved_datum_6d(const T1 &datum_1, const T2 &datum_2,
      const T3 &datum_3, const T4 &datum_4, const T5 &datum_5,
      const T6 &datum_6);

    /*! \brief copy constructor
     */
    interleaved_datum_6d(const interleaved_datum_6d &rhs);

    /*! \brief assignment uses copy-swap idiom
     */
    interleaved_datum_6d &operator=(interleaved_datum_6d rhs);
  };
}

#include "interleaved_datum_6d.inl"
#endif
