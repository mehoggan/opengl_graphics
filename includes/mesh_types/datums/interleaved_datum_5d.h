 ...
 *
 */
#ifndef INTERLEAVED_DATUM_5D_H_INCLUDED
#define INTERLEAVED_DATUM_5D_H_INCLUDED

namespace opengl_graphics
{
  template <typename T1, typename T2, typename T3, typename T4, typename T5>
  struct interleaved_datum_5d
  {
  public:
     ...
     */
    interleaved_datum_5d();

    /*! \brief constructor
     */
    interleaved_datum_5d(const T1 &datum_1, const T2 &datum_2,
      const T3 &datum_3, const T4 &datum_4, const T5 &datum_5);

    /*! \brief copy constructor
     */
    interleaved_datum_5d(const interleaved_datum_5d &rhs);

    /*! \brief assignment uses copy-swap idiom
     */
    interleaved_datum_5d &operator=(interleaved_datum_5d rhs);
  };
}

#include "interleaved_datum_5d.inl"
#endif
