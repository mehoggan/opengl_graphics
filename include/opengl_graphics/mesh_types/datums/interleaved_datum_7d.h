 ...
 *
 */
#ifndef INTERLEAVED_DATUM_7D_H_INCLUDED
#define INTERLEAVED_DATUM_7D_H_INCLUDED
...
namespace opengl_graphics
{
  ...
  public:
     ...
     */
    interleaved_datum_7d();

    /*! \brief constructor
     */
    interleaved_datum_7d(const T1 &datum_1, const T2 &datum_2,
      const T3 &datum_3, const T4 &datum_4, const T5 &datum_5,
      const T6 &datum_6, const T7 &datum_7);

    /*! \brief copy constructor
     */
    interleaved_datum_7d(const interleaved_datum_7d &rhs);

    /*! \brief assignment uses copy-swap idiom
     */
    interleaved_datum_7d &operator=(interleaved_datum_7d rhs);
  };
}

#include "interleaved_datum_7d.inl"
#endif
