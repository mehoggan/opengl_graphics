...
namespace opengl_graphics
{
  ...
  <
    ...
    typename T5 = nat, typename T6 = nat, typename T7 = nat,
    typename T8 = nat, typename T9 = nat, typename T10 = nat
  >
...
namespace opengl_graphics // 9 attributes
{
  ...
  {
  public:
    typedef interleaved_datum_9d<T1, T2, T3, T4, T5, T6, T7, T8, T9>
      datum_type;
    typedef shared_array<datum_type> collection_type;
